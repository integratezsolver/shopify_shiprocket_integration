...
public class OrderMapperService {
    ...
    /**
     * Saves all orders one-by-one from Shopify pagination result
     */
//    public List<Order> saveAllOrders(List<Map<String, Object>> ordersJson, User currentUser) {
//
...
//
//    /**
//     * Save a single Shopify order safely
//     */
